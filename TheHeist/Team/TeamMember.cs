...
namespace TheHeist.Team
{
    class TeamMember
    {
        ...
        public int CourageFactor { get; set; } //how can I force a range? AND - how can I store it as a decimal from the Console user entry??
        //[Range(typeof(decimal), "0.0", "2.0")]

        //methods:
        public void DisplayTeamMember(string name, int skillLevel, int courageFactor)
        {
            Name = name;
